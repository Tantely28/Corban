		...
		<div class="container">
			<div class="row"  style="padding-top: 100px;">
				...
				<p style="color: #000;
						  ...
						  font-family:'Raleway', sans-serif;
						  text-align: center;
						  font-size: 30px;">Postuler avant le 15 Mai 2019
				</p>
    ...
    xrh.onreadystatechange=function () {
        if (this.readyState === 4 && this.status === 200) {
            ...
            var arr=JSON.parse(xrh.response);
                ...
                document.getElementById("det").innerHTML +='<h2>'+arr.poste+'</h2><p><strong>Type de contrat :</strong>&nbsp;'+arr.contrat+'</p><p><strong>Date limite:</strong>&nbsp;'+arr.dateLimite+'</p><p><strong>Activités :</strong> &nbsp;'+arr.activite+'</p><p><strong>Mission:</strong><br>'+arr.mission+'</p><p><strong>Profil:</strong>&nbsp;'+arr.profile+'</p><p><strong>Référence :</strong>&nbsp;'+arr.reference+'</p>'
